...
export default function Lon() {
  ...
  const amountFormat = (amount: number) =>
    ...
    const {colh1 , colP , colPars ,
       colYear , colColl , month ,
        paymenT , payT , paySection ,payRemain, pRint} = Language;
      ...
      <div className="loan-calculator-container">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-item">
            <label htmlFor="loan-amount" className="lnDt">{colP[lang]}</label>
          ...
          <div className="form-item">
            <label htmlFor="interest-rate" className="lnDt">{colPars[lang]}</label>
            <div className="form-input">
              <input
                type="number"
                name="interest-rate"
          ...
          <div className="form-item">
            <label htmlFor="loan-term" className="lnDt">{colYear[lang]}</label>
            <div className="form-input">
              <input
                type="number"
                name="loan-term"
          ...
          <div className="form-action">
            <input
              ...
              />
             <button onClick={handlePrint} className="print__button">{pRint[lang]}</button>
          </div>
        </form>
        {!!installments?.length && (
