...
const Header = (props) => {
    ...
    const getTotlas = () => {
        axios
            .get('https://dev-rauto.uz/total/all')
            .then(res => {
            ...
            <header className="headers">
                ...
                <div className="bth">
                    <div className="lwr">
                        ...
                        <div id="anDiv">
                            <section className="social_numbers">
                                    <span style={{position:"absolute",fontWeight:"900",color:"#000",width:"300px"}}><b>{avM[lang]}</b></span>
                                    <div className="numText">
                                     {totals.map((e) => { return <p>{e.total}</p> })}
                                    </div>
                            </section>
                        </div>
                    </div>
