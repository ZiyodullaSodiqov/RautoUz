...
function Contact(props) {
    ...
    const [data, setData] = useState({ name: '', phone: '' , email: '' , description: '' })
    const order = async () => {
        await axios
            .post('https://dev-rauto.uz/contact/add', data)
            ...
            <div className="w-box">
                ...
                <div className="w-b1">
                    ...
                    >
                        ...
                        >
                            <Input className="inp" onChange={e => setData({ ...data, name: e.target.value })} value={data.name} type="text" placeholder={m1[lang]} />
                        </Form.Item>
                        ...
                        >
                            <Input className="inp" onChange={e => setData({ ...data, phone: e.target.value })} value={data.phone} type="number" placeholder={m2[lang]} />
                        </Form.Item>
                        ...
                        >
                            <Input className="inp" onChange={e => setData({ ...data, email: e.target.value })} type="email" value={data.email} placeholder={mailA[lang]} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            rules={[{ required: true, message: req[lang] }]}
                        >
                            <TextArea rows={4} onChange={e => setData({ ...data, description: e.target.value })} value={data.description} />
                        </Form.Item>

                        <Form.Item className="sub">
                            <Button type="primary" onClick={order} htmlType="reset" style={{ float: "right" }}>
                                {send[lang]}
                            </Button>
                        </Form.Item>
                    </Form>
